...
public class DynamicArray<T> {
    ...
    public void add(T element) {
        if (size >= MAX_CAPACITY) {
            System.out.println("Array capacity exceeded. Cannot add more elements.");
            return;
        }
    ...
    public void set(int index, T element) {
        if (index < 0 || index >= size) {
            System.out.println("Invalid index. Cannot set element.");
            return;
        }
    ...
    public T getSecondMax() {
        if (size < 2) {
            System.out.println("Array contains less than 2 elements. Cannot find second maximum value.");
            return null;
        }
        T max = (T) elements[0];
